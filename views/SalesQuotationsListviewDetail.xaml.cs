...
namespace SalesApp.views
{
    ...
    public partial class SalesQuotationsListviewDetail : PopupPage
    {
        ...
        List<serial_list> serialList_edit = new List<serial_list>();
        ...
        public SalesQuotationsListviewDetail(SalesQuotation item)
        {
         ...
         //   ST.Text = item.team_id;
          ...
          //  userlocation.Text = App.user_location_string;
            ...
            for (int i = 0; i < item.order_line.Count; i++)
            {
              //  serialList_edit.Add(item.order_line[i].lot_ids[i].);
            }
            ...
            sq_editRecognizer.Tapped += async (s, e) =>
            {
               ...
               //     ptpicker_edit.IsVisible = true;
                 ...
                 //   delmethod_edit.IsVisible = true;
                    payment_journaledit.IsVisible = true;
                 ...
                 //   delmethod_noedit.IsVisible = false;
                    payment_journalnoedit.IsVisible = false;
...

                    {
                        ...
                        payment_Picker.ItemsSource = App.journalList.Select(x => x.name).ToList();
                        payment_Picker.SelectedItem = item.journal_id;
     ...
     //newly added ends here
                     ...
                     //   price_list_label.Text = item.pricelist;
                 ...
                 //   discount_grid_ol.IsVisible = false;
                    ...
                    seriallistviewGrid_ol.IsVisible = false;
            ...
            addbtn_orderlineRecognizer.Tapped +=  (s, e) =>
            {
             ...
             //   discount_grid_ol.IsVisible = true;
                ...
                seriallistviewGrid_ol.IsVisible = true;
                addbtn_orderline.IsVisible = false;
                savebtn_layout.IsVisible = true;
                updatebtn.IsVisible = false;
                ...
                serialStackLayout_ol.IsVisible = false;

                taxlistviewGrid_ol.Padding = new Thickness(15, 0, 0, 0);
                seriallistviewGrid_ol.Padding = new Thickness(15, 0, 0, 0);

                taxStackLayout_ol.Padding = new Thickness(15, 0, 0, 0);
                serialStackLayout_ol.Padding = new Thickness(15, 0, 0, 0);
            ...
            //  int product_id = App.productList.FirstOrDefault(x => x.Name == searchprod.Text.ToString()).Id;

               App.serialList = Controller.InstanceCreation().getserialList(product_id);
            ...
            var Addserial_lineImgRecognizer_ol = new TapGestureRecognizer();
            Addserial_lineImgRecognizer_ol.Tapped += (s, e) => {

                // addtaxGrid.IsVisible = true;
                Addserial_line.IsVisible = false;
                Addserial_line_ol.IsVisible = true;

                int product_id = App.productList.FirstOrDefault(x => x.Name == searchprod_ol.Text.ToString()).Id;

                App.serialList = Controller.InstanceCreation().getserialList(product_id);

                Navigation.PushPopupAsync(new SerialSelectionPage("serial_new"));

            };
            Addserial_line_ol.GestureRecognizers.Add(Addserial_lineImgRecognizer_ol);
        ...
        protected override void OnAppearing()
        {
            ...
            MessagingCenter.Subscribe<string, string>("MyApp", "serialPickerMsg", (sender, arg) =>
            {
                ...
                serialList_edit.Add(new serial_list(arg));

                serialList_edit = serialList_edit.GroupBy(i => i.name).Select(g => g.First()).ToList();
              
                serialStackLayout.IsVisible = true;
                serialListView.ItemsSource = serialList_edit;
                serialListView.RowHeight = 30;
                serialListView.HeightRequest = 30 * serialList_edit.Count;
                ...
                serialStackLayout.Padding = new Thickness(5);


                // taxpickstringList.Add(taxpicker.SelectedItem.ToString());
                var serialsid =
               (
                        from i in App.serialList
                        where i.name == arg
               ...
               select new
               {
                ...
                foreach (var person in serialsid)
                {
                    int selectserialid = person.id;
                    serialidList.Add(selectserialid);
            ...
            MessagingCenter.Subscribe<string, string>("MyApp", "serialnewPickerMsg", (sender, arg) =>
            {

                serialListView_ol.ItemsSource = null;

                serialList_edit.Add(new serial_list(arg));

                serialList_edit = serialList_edit.GroupBy(i => i.name).Select(g => g.First()).ToList();
              
                serialStackLayout_ol.IsVisible = true;
                serialListView_ol.ItemsSource = serialList_edit;
                serialListView_ol.RowHeight = 35;
                serialListView_ol.HeightRequest = 35 * serialList_edit.Count;

                serialStackLayout_ol.BackgroundColor = Color.FromHex("#363E4B");
                serialListView_ol.BackgroundColor = Color.FromHex("#363E4B");
                serialStackLayout_ol.CornerRadius = 20;

                serialStackLayout_ol.Padding = new Thickness(5);
               ...
               select new
               {
                ...
                foreach (var person in serialssid)
                {
                    int selectserialid = person.id;
                    serialidList.Add(selectserialid);
                    serialidList = serialidList.GroupBy(i => i).Select(g => g.First()).ToList();
        ...
        public void serialListviewcloseClicked(object sender, EventArgs e1)
        {
            try
            {
                var args = (TappedEventArgs)e1;
                ...
                var itemToRemove = serialList_edit.Single(r => r.name == t2.name);

                serialList_edit.Remove(itemToRemove);
                ...
                serialListView.HeightRequest = 35 * serialList_edit.Count;



                if (serialList_edit.Count == 0)
                {
        ...
        public void serialListview_ol_closeClicked(object sender, EventArgs e1)
        {
            try
            {
                var args = (TappedEventArgs)e1;
                ...
                if (serialList_edit.Count == 0)
                {
                    serialStackLayout_ol.BackgroundColor = Color.White;
                    serialListView_ol.BackgroundColor = Color.White;
                    serialStackLayout_ol.CornerRadius = 0;
                    serialStackLayout_ol.Padding = 0;
                }
          ...
          //  discount_grid_ol.IsVisible = false;
            ...
            if (editbtn_clicked == true)
            {
             ...
             //   multidis.Text = masterItemObj.multi_discount;
                ...
                product_id = masterItemObj.product_id;
       ...
       //serial starts here
                ...
                serial_list serialname = new serial_list("");

                for (int i = 0; i < masterItemObj.lots.Count(); i++)
                {

                    string sername = masterItemObj.lots[i].ToString();
                    //int serid = Int32.Parse(sername);

                    //var serial_list = from tx in App.serialList
                    //                                    where tx.id == serid
                    //               select tx;

                    //string name = "";
                    //foreach (var serial in serial_list)
                    //{
                    //    name = serial.name;
                    //}


                    if (masterItemObj.lots[i] != null)
                    {

                        serialList_edit.Add(new serial_list(sername));
                    }
                ...
                if (serialList_edit.Count == 0)
                {
                    serialStackLayout.BackgroundColor = Color.FromHex("#F0EEEF");
                    serialListView.BackgroundColor = Color.FromHex("#F0EEEF");
                    seriallistviewGrid.Padding = new Thickness(15, 0, 0, 0);
                    serialStackLayout.Padding = new Thickness(0, 0, 0, 0);
                }
...
//  orderLinenew.taxes = tax_id;
                try
                {
                   ...
                   // Double tot = Double.Parse(orderLinenew.price_subtotal) * (Double.Parse(dis1_ol.Text) / 100);
                    ...
                    Double tot = Double.Parse(orderLinenew.price_subtotal) * (Double.Parse("0") / 100);
 ...
 //serial starts here
                ...
                Object[] serial_id = new object[serialList_edit.Count()];

                for (int i = 0; i < serialList_edit.Count(); i++)
                {
                    var ser_list = from tx in App.serialList
                                                     where tx.name == serialList_edit[i].name.ToString()
                                   select tx;

                    int ser_list_id = 0;
                    foreach (var ser in ser_list)
                    {
                        ser_list_id = ser.id;
                    }
                    ...
                    serial_id[i] = ser_list_id;

                    orderLinenew.lot_ids = serial_id;
        ...
        //serial list starts here

                    Object[] ser_id = new object[serialList_edit.Count()];
                    ...
                    for (int i = 0; i < serialList_edit.Count(); i++)
                    {
                        ...
                        ser_id[i] = ser_list_id;

                        orderLine.lot_ids = ser_id;
                    ...
                    try
                    {
                      ...
                      //  Double tot = Double.Parse(orderLine.price_subtotal) * (Double.Parse(dis1.Text) / 100);
                        ...
                        Double tot = Double.Parse(orderLine.price_subtotal) * (Double.Parse("0") / 100);
              ...
              //  orderLine.tax_id = tax_id;
                ...
                orderLineupdate.serial_id = newobj.lot_ids;
            ...
            Cus.Text = searchcus.Text.ToString();
            ...
            if (App.NetAvailable == true)
            {
                ...
                try
                {
                  ...
                  //  vals["delivery_deadline"] = deldead_string;
                    ...
                    try
                    {
                        string ids = App.product_PriceList.First(c => c.name == price_list_label.Text.ToString()).id;
                ...
                //    vals["franco"] = franco_entry.Text;
                 ...
                 //   vals["special_notes"] = comments.Text;
                    ...
                    try
                    {
                        var payment_journal_id = App.journalList.FirstOrDefault(x => x.name == payment_Picker.SelectedItem.ToString()).id;
